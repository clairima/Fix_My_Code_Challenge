...
if user_1.id is None:
    ...
    if not user_1.is_valid_password(u_pwd):
        print("is_valid_password should return True if its right pass")
    if user_1.is_valid_password("Fakepwd"):
        print("is_valid_password return False if its not right pass")
    if user_1.is_valid_password(None):
        print("is_valid_password should return False if comp None")
    if user_1.is_valid_password(89):
        print("is_valid_password should return False if comp with int")
    if user_2.is_valid_password("No pwd"):
        print("is_valid_password should return False if no pass before")
